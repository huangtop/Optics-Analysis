...
COMPANIES = {
    ...
    "Vishay Intertechnology": {
        ...
        "categories": [
            ...
            "High Voltage MLCC",
            "Automotive MLCC",
            "Soft Termination / Anti-Bend",
            "AI Server Power MLCC",
            "RF / High-Q MLCC",
            "Specialty MLCC",
        ],
    },
    ...
    "Sakai Chemical": {
        ...
        "market": "JP",
        "exchange": "TSE",
        "categories": ["Dielectric Powder / BaTiO3"],
    },
...
OUTPUT_PATH = OUTPUT_DIR / "mlcc_stock_prices_1y.json"
...
# =========================================================
# 4) 建立 categories 索引
#    前端選 "AI Server Power MLCC" 等分類就先查這裡
# =========================================================
